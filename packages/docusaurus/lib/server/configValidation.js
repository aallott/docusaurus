...
const PluginSchema = joi_1.default.alternatives().try(joi_1.default.string(), joi_1.default.array().items(joi_1.default.string().required(), joi_1.default.object().required()).length(2), joi_1.default.bool().equal(false));
